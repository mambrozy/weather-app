...
const view = (() => {
  function setSearchResult(weatherData) {
    ...
    feelsLike.textContent = `Odczuwalna: ${weatherData.feelsLike} °C`;
    humidity.textContent = `Wigotność: ${weatherData.humidity} %`;
    wind.textContent = `Wiatr: ${weatherData.windSpeed} km/h`;
  }
...
const weather = (() => {
  ...
  async function getData(city) {
    const endpoint = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=1853fcd86a1f942c057ef5472ed8918c`;
    try {
